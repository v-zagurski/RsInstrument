...
# Command integer value that signals to skip the entire header in the command
VALUE_SKIP_HEADER = -3

# This is the string when the header should be skipped
...
class RepeatedCapability(object):
	...
	def clsm_get_cmd_string_value(cls, enum_value: Enum | int, enum_type) -> str:
		...
		if number == VALUE_SKIP_HEADER:
			return CMD_VALUE_SKIP_HEADER
